 ...
 * @author JEFF
 */
public class Prcs_LimpiezaHorario extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prcs_LimpiezaHorario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Prcs_LimpiezaHorario().setVisible(true);
            }
        });
    }
