...
public class Mnt_Huespedes extends javax.swing.JInternalFrame {
    ...
    public void actualizarTabla(String codigo) {
        ProcesosRepetidos prcs_repetidos = new ProcesosRepetidos();
        huespedesDAO.codigoAuxiliar = codigo;
        huespedesDAO.nombreAuxiliar = codigo;
        huespedesDAO.apellidoAuxiliar = codigo;
        ...
        huespedesDAO serviciosdao = new huespedesDAO();
        List<Huespedes> servicio = serviciosdao.select();
        for (Huespedes listaServicio : servicio) {
            datos[0] = listaServicio.getPasaporte();
            datos[1] = listaServicio.getNombre();
            datos[2] = listaServicio.getApellido();
            if (listaServicio.getSexo().equals("1")) {
                datos[3] = "F";
            } else {
                datos[3] = "M";
            }
    ...
    public void Limpiar() {
        prcs_repetidos.Limpiar(Txt_codigo, Txt_nombre, Txt_apellido, Txt_buscar, Txt_nacionalidad, Txt_telefono, Txt_cumple, Txt_correo);
    ...
    private void initComponents() {
        ...
        Txt_cumple = new javax.swing.JTextField();
        ...
        Txt_cumple.setBackground(new java.awt.Color(36, 47, 65));
        Txt_cumple.setForeground(new java.awt.Color(255, 255, 255));
        Txt_cumple.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                    ...
                    .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                        ...
                        .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(Txt_nacionalidad, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jSeparator5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(Txt_correo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(Txt_cumple, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                ...
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Lbl_estado)
                            .addComponent(Rdb_inactivo, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addComponent(Rdb_activo))
                ...
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Lbl_precio4)
                    .addComponent(Txt_cumple, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void Tbl_DatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tbl_DatosMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Txt_cumple.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 7).toString());
        }
    ...
    private void Btn_modificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_modificarMouseClicked
        if (prcs_repetidos.isNoneEmpty(Txt_codigo, Txt_nombre, Txt_apellido, Txt_nacionalidad, Txt_telefono, Txt_correo, Txt_cumple)) {
            if (prcs_repetidos.isSelected(Rdb_activo, Rdb_inactivo)) {
                if (prcs_repetidos.isNumeric(Txt_codigo.getText(), Txt_telefono.getText())) {
                    ...
                    huespedes.setCumple(Txt_cumple.getText());
    ...
    private javax.swing.JTextField Txt_cumple;
