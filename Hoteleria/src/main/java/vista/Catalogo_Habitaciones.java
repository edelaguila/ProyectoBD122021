...
public class Catalogo_Habitaciones extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Catalogo_Habitaciones
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Catalogo_Habitaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Catalogo_Habitaciones().setVisible(true);
            }
        });
    }
