...
public class HuespedDAO {
    ...
    public int insert(Huesped huespedes) {
    ...
    public int update(Huesped huespedes) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
...
//          System.out.println("ejecutando query: " + SQL_UPDATE);
    ...
    public Huesped query(Huesped huespedes) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        int rows = 0;
    ...
    public int delete(Huesped huespedes) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
