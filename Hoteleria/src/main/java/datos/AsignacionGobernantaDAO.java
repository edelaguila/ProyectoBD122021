...
public class AsignacionGobernantaDAO {
    ...
    private static final String SQL_QUERY = "SELECT PK_id_asignacion_gobernanta, PK_id_gobernanta, PK_id_ama_de_llave, estado_asignacion_gobernanta FROM tbl_asignacion_gobernanta WHERE PK_id_asignacion_gobernanta = ?";
    private static final String SQL_DELETE = "delete from tbl_asignacion_gobernanta where PK_id_asignacion_gobernanta = ?";
    private static final String SQL_SELECT = "SELECT empresarial.tbl_empleado.PK_id_empleado as ID, empresarial.tbl_empleado.nombre_empleado as NOMBRE FROM tbl_empleado INNER JOIN tbl_puesto ON empresarial.tbl_empleado.puesto_empleado = empresarial.tbl_puesto.nombre_puesto WHERE empresarial.tbl_puesto.nombre_puesto='Ama de Llave' AND empresarial.tbl_empleado.estado_empleado='1'";

    private static final String SQL_QUERY_GOBERNANTA = "SELECT PK_id_puesto FROM tbl_puesto WHERE nombre_puesto='Gobernanta'";
    private static final String SQL_PK = "PK_id_puesto";
    private static final String SQL_QUERY_PISO = "SELECT PK_id_piso FROM tbl_piso";
    ...
    public int insert(AsignacionGobernanta asignacionGobernanta) {
        ...
        try {
            ...
            stmt.setString(3, asignacionGobernanta.getIdPiso());
            stmt.setString(4, asignacionGobernanta.getIdAmaDeLlave());
            stmt.setString(5, asignacionGobernanta.getNombreAmaDeLlave());
            stmt.setString(6, asignacionGobernanta.getEstadoAsignacionGobernanta());
...
//        return rows;
//    }
//    public AsignacionGobernanta query(AsignacionGobernanta asignacionGobernanta) {
//        Connection conn = null;
//        PreparedStatement stmt = null;
//        ResultSet rs = null;
//        int rows = 0;
...
//                String estado = rs.getString("estado_asignacion_gobernanta");
//
//                asignacionGobernanta = new AsignacionGobernanta();
//                asignacionGobernanta.setIdAsignacionGobernanta(id);
//                asignacionGobernanta.setIdGobernanta(gobernanta);
//                asignacionGobernanta.setIdAmaDeLlave(amaDeLlave);
//                asignacionGobernanta.setEstadoAsignacionGobernanta(estado);
//            }
//        } catch (SQLException ex) {
//            ex.printStackTrace(System.out);
//        } finally {
