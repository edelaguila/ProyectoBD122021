...
public class AmaDeLlave {
    ...
    public String getEstadoAmaDeLlave() {
    ...
    public String getApellidoAmaDeLlave() {
        return apellidoAmaDeLlave;
    }

    public void setApellidoAmaDeLlave(String apellidoAmaDeLlave) {
        this.apellidoAmaDeLlave = apellidoAmaDeLlave;
    }

    public String getDescripcionAmaDeLlave() {
        return descripcionAmaDeLlave;
    }
