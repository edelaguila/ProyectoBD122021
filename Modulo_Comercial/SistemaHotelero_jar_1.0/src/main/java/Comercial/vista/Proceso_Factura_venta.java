...
public void llenadoDeTablas() {
        ...
        List<Factura_Venta > ventas = ventasDAO.select1();
        Jtfactura.setModel(modelo);
        String[] dato = new String[4];
        for (int i = 0; i < ventas.size(); i++) {
            dato[0] = (ventas.get(i).getFecha_vencimiento());
            dato[1] = ventas.get(i).getCodigo_cliente();
             dato[2] = ventas.get(i).getCantidad_servicio();
...
public Proceso_Factura_venta() {
    ...
    private void initComponents() {
        ...
        Txt_ccobrador = new javax.swing.JLabel();
        ...
        Txt_ccobrador.setText("jLabel7");
        jPanel2.add(Txt_ccobrador, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 170, 90, -1));

        Txt_vendedor.setText("jLabel7");
        jPanel2.add(Txt_vendedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 140, 90, -1));

        Txt_cliente.setText("jLabel7");
        jPanel2.add(Txt_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, 110, -1));
 ...
 Factura_VentaDao Factura_VentaDao  = new Factura_VentaDao();
      ...
      Factura_Venta AInsertar = new Factura_Venta();
       Factura_Venta AInsertar1 = new Factura_Venta();
        ...
        AInsertar.setCodigo_cliente(Txt_cliente.getText());
         AInsertar.setCodigo_vendedor(Txt_vendedor.getText());
          AInsertar.setCodigo_cobrador(Txt_ccobrador.getText());
            AInsertar.setSubtotal_encabezado(Txt_total.getText());
        AInsertar1.setFecha_vencimiento(Txt_fecha1.getText());
        AInsertar1.setSubtotal_encabezado(Txt_total.getText());
        AInsertar1.setPrecio_servicio(Txt_servicio.getText());
        
AInsertar1.setCantidad_servicio(Txt_cantidad.getText());
        AInsertar.setImpuesto_iva_encabezado(Txt_impuesto.getText());
        Factura_VentaDao.update(AInsertar);
...
AInsertar1.setCantidad_servicio(Txt_cantidad.getText());
        AInsertar.setImpuesto_iva_encabezado(Txt_impuesto.getText());
        Factura_VentaDao.insert(AInsertar);
           Factura_VentaDao.insert(AInsertar1);
//
//        llenadoDeTablas();
//        limpiar();
...
//        JOptionPane.showMessageDialog(null, " La ejecucion  a  sido un exito");
    ...
    private javax.swing.JLabel Txt_ccobrador;
