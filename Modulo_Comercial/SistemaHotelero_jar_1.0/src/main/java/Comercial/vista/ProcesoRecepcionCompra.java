...
import Comercial.datos.RecepcionCompraDAO;
import Comercial.dominio.RecepcionCompra;
import Comercial.datos.RecepcionCompraDetalleDAO;
import Comercial.dominio.RecepcionCompraDetalle;
 ...
 */
public class ProcesoRecepcionCompra extends javax.swing.JInternalFrame {
     ...
     */
    RecepcionCompra fecha2 = new RecepcionCompra();
    SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
    Date fechaemision = null;

   RecepcionCompra fecha3 = new RecepcionCompra();
    ...
    public void llenadoDeTablas() {
        ...
        RecepcionCompraDAO proveedorDAO = new RecepcionCompraDAO();

        List<RecepcionCompra> proveedor = proveedorDAO.select();
        TablaFacturaEncabezado.setModel(modelo);
        String[] dato = new String[6];
        for (int i = 0; i < proveedor.size(); i++) {
            dato[0] = Integer.toString(proveedor.get(i).getPK_codigo_RecepcionCompra());
            ...
            dato[5] = proveedor.get(i).getEstatus_recepcioncompra();
            modelo.addRow(dato);
        }
    ...
    public void uno() {
        ...
        RecepcionCompraDetalleDAO proveedorDAO = new RecepcionCompraDetalleDAO();

        List<RecepcionCompraDetalle> proveedor = proveedorDAO.select();
        TablaFacturaDetalle.setModel(modelo);
        String[] dato = new String[7];
        for (int i = 0; i < proveedor.size(); i++) {
            dato[0] = Integer.toString(proveedor.get(i).getCorrelativo());
            dato[1] = Integer.toString(proveedor.get(i).getPK_Codigo_Recepcioncompra());
...
//        llenadoDeTablas();
    ...
    private void initComponents() {
        ...
        LbTITULO.setText("Recepcion De Compra Hotel San Carlos");
        ...
        PanelFacturaDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Recepcion Compra Datos"));
        ...
        Lbfacturadetalle.setText("Recepcion Compra Detalle");

        Lbfecha.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N

        PanleFacturaDetalles.setBackground(new java.awt.Color(255, 255, 255));
        PanleFacturaDetalles.setBorder(javax.swing.BorderFactory.createTitledBorder("RecepcionCompra Enzabezado"));
        ...
        Lbfacturadetalle1.setText("Recepcion Compra Detalle");
        ...
        PanleFacturaDetallesLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanleFacturaDetallesLayout.createSequentialGroup()
                ...
                .addGroup(PanleFacturaDetallesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanleFacturaDetallesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        PanelFacturaDatosLayout.setHorizontalGroup(
            ...
            .addGroup(PanelFacturaDatosLayout.createSequentialGroup()
                                ...
                                .addGroup(PanelFacturaDatosLayout.createSequentialGroup()
                                    .addGroup(PanelFacturaDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(PanelFacturaDatosLayout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                            .addComponent(txt_IdProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGap(18, 18, 18)
                .addComponent(PanleFacturaDetalles, javax.swing.GroupLayout.PREFERRED_SIZE, 562, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(172, 172, 172))
                    .addComponent(PanelFacturaDatos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void TablaFacturaEncabezadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaFacturaEncabezadoMouseClicked
        ...
        try {
            ...
            Logger.getLogger(ProcesoRecepcionCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        txtTotall.setText(String.valueOf(tot));
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        RecepcionCompraDetalleDAO emisionchequeDAO = new RecepcionCompraDetalleDAO();
        RecepcionCompraDetalle insertar = new RecepcionCompraDetalle();

        insertar.setPK_Codigo_Recepcioncompra((int) Integer.parseInt(LbNofactura.getText()));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        RecepcionCompraDAO proveedorDAO = new RecepcionCompraDAO();
        RecepcionCompra proveedorAEliminar = new RecepcionCompra();
        proveedorAEliminar.setPK_codigo_RecepcionCompra(Integer.parseInt(LbNofactura.getText()));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
         RecepcionCompraDAO proveedorDAO = new  RecepcionCompraDAO();
         RecepcionCompra proveedorAActualizar = new  RecepcionCompra();
        proveedorAActualizar.setPK_codigo_RecepcionCompra(Integer.parseInt(LbNofactura.getText()));
        ...
        proveedorAActualizar.setEstatus_recepcioncompra(txt_Estatus.getText());
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        RecepcionCompraDAO emisionchequeDAO = new RecepcionCompraDAO();
        RecepcionCompra insertar = new RecepcionCompra();
        ...
        insertar.setEstatus_recepcioncompra(txt_Estatus.getText());
    ...
    private void btnEliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminar1ActionPerformed
        // TODO add your handling code here:
        RecepcionCompraDetalleDAO proveedorDAO = new RecepcionCompraDetalleDAO();
        RecepcionCompraDetalle proveedorAEliminar = new RecepcionCompraDetalle();
    ...
    private void btnModificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificar1ActionPerformed
        // TODO add your handling code here:
       RecepcionCompraDetalleDAO proveedorDAO = new RecepcionCompraDetalleDAO();
        RecepcionCompraDetalle proveedorAActualizar = new RecepcionCompraDetalle();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Insertar.setTransaccion("RecepcionCompra");
        String Inicio = new SimpleDateFormat("yyyy/MM/dd").format(txt_FechaEmision.getDate());
        String Inicio1 = new SimpleDateFormat("yyyy/MM/dd").format(txt_FechaVencimiento.getDate());
        Insertar.setFecha_emision(Inicio);
