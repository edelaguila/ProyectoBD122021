...
import Comercial.datos.Pedido_VentaDao;
import Comercial.datos.Pedido_VentaDao1;
...
import Comercial.dominio.Pedido_Venta;
 ...
 * @author PERSONAL
 */
public class Proceso_Pedido_venta extends javax.swing.JInternalFrame {
ClienteDao Cliente= new   ClienteDao  ();
  ...
  Pedido_VentaDao Buscar3  = new Pedido_VentaDao();  
  Pedido_VentaDao1 Buscar4  = new Pedido_VentaDao1();  
  Pedido_Venta venta  = new Pedido_Venta();
 Pedido_Venta venta1  = new Pedido_Venta();  
  /**
...
public void llenadoDeDatos1() {
  Pedido_VentaDao Pedido_VentaDao  = new Pedido_VentaDao();
 Pedido_VentaDao1 Pedido_VentaDao1  = new Pedido_VentaDao1();
        Pedido_Venta AInser = new Pedido_Venta();
      
        AInser.setCodigo_pedido_encabezado(txt_encabezado.getText());
        ...
        AInser.setEstatus_pedido(txt_estatus.getText());
...
public void llenadoDeDatos2() {
 ...
 Pedido_VentaDao1 Pedido_VentaDao1  = new Pedido_VentaDao1();
        ...
        Pedido_Venta AInser1 = new Pedido_Venta();
        AInser1.setCodigo_pedido_encabezado(txt_encabezado.getText());
        ...
        Pedido_VentaDao1.delete(AInser1);
...
modelo.addColumn("Servicio");
        ...
        Pedido_VentaDao  ventasDAO = new Pedido_VentaDao ();

        List<Pedido_Venta> ventas = ventasDAO.select();
//        List<Factura_Venta > ventas1 = ventasDAO1.select1();
        ...
        for (int i = 0; i < ventas.size(); i++) {
             ...
             dato[2] = ventas.get(i).getCodigo_pedido_encabezado();
            ...
            dato[10] = ventas.get(i).getSubtotal_encabezado();
             dato[11] = ventas.get(i).getEstatus_pedido();
...
txt_encabezado.setText(venta.getCodigo_pedido_encabezado());
txt_encabezado.setText(venta1.getCodigo_pedido_encabezado());
...
txt_estatus.setText(venta.getEstatus_pedido());
...
llenadoDeTabla2();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PEDIDO  ENCABECERA");
        ...
        jPanel2.add(jToggleButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 233, 90, 30));
        ...
        jPanel2.add(jToggleButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 233, 80, 30));
        ...
        jPanel2.add(jToggleButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 233, 90, 30));
        ...
        jLabel3.setText("PEDIDO DETALLE");
        ...
        jPanel3.add(c, new org.netbeans.lib.awtextra.AbsoluteConstraints(241, 123, 80, 30));
        ...
        jPanel3.add(jToggleButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 120, 110, 30));
        ...
        jPanel3.add(Btn_Modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 227, 100, 30));
        ...
        jPanel3.add(Btn_Eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 90, 30));
        ...
        jLabel4.setText("PEDIDO  PENDIENTE");

        jLabel5.setText("PEDIDO  EN LINEA");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(37, 37, 37)
                                        .addComponent(Btn_reporte, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(38, 38, 38)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel5)
                                    .addComponent(jLabel4))
                                .addComponent(Btn_Agregar1, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
...
Pedido_VentaDao Pedido_VentaDao  = new Pedido_VentaDao();
 Pedido_VentaDao1 Pedido_VentaDao1  = new Pedido_VentaDao1();
        ...
        Pedido_VentaDao1.update1(AInser1);
...
//
 ...
 Pedido_VentaDao1  Pedido_VentaDao1  = new  Pedido_VentaDao1();
        ...
        AInser1.setCantidad_servicio(Txt_cantidad.getText());
         ...
         Pedido_VentaDao1.insert1(AInser1);
...
// TODO add your handling code here:
  ...
  Pedido_VentaDao Factura_VentaDao  = new  Pedido_VentaDao();
  Pedido_VentaDao1 Factura_VentaDao1  = new  Pedido_VentaDao1();
         Pedido_Venta AInser = new  Pedido_Venta();
 ...
 AInser.setServicio(Txt_servicio.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if ((new File("src\\main\\java\\Comercial\\reportes\\pedido.chm")).exists()) {
                Process p = Runtime
                .getRuntime()
                .exec("rundll32 url.dll,FileProtocolHandler src\\main\\java\\Comercial\\reportes\\pedido.chm");
                p.waitFor();
            } else {
