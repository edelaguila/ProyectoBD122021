 ...
 * @author PERSONAL
 */
public class Factura_VentaDao1 {
  private static final String SQL_INSERT1 = "INSERT INTO tbl_factura_detalle(no_serie,codigo_factura_encabezado,cantidad_servicio,precio_servicio) VALUES(?,?,?,?)";
  private static final String SQL_UPDATE1 = "UPDATE tbl_factura_detalle SET no_serie=?,codigo_factura_encabezado=?,cantidad_servicio=?,precio_servicio=? WHERE no_serie"; 
   private static final String SQL_SELECT1 = "SELECT  no_serie,codigo_factura_encabezado,cantidad_servicio,precio_servicio  FROM tbl_factura_detalle";
      private static final String SQL_QUERY1 = "SELECT  no_serie,codigo_factura_encabezado,cantidad_servicio,precio_servicio  FROM tbl_factura_detalle  WHERE no_serie = ?";
      private static final String SQL_DELETE1 = "DELETE FROM tbl_factura_detalle  WHERE no_serie = ? ";
