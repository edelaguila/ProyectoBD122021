 ...
 * @author PERSONAL
 */
public class Devolucion_VentaDao1 {
  private static final String SQL_INSERT1 = "INSERT INTO tbl_devolucion_venta_detalle(no_serie,codigo_devolucion_encabezado,cantidad_servicio,precio_servicio) VALUES(?,?,?,?)";
  private static final String SQL_UPDATE1 = "UPDATE tbl_devolucion_venta_detalle SET no_serie=?,codigo_devolucion_encabezado=?,cantidad_servicio=?,precio_servicio=? WHERE no_serie"; 
   private static final String SQL_SELECT1 = "SELECT  no_serie,codigo_devolucion_encabezado,cantidad_servicio,precio_servicio  FROM tbl_devolucion_venta_detalle";
      private static final String SQL_QUERY1 = "SELECT  no_serie,codigo_devolucion_encabezado,cantidad_servicio,precio_servicio  FROM tbl_devolucion_venta_detalle  WHERE no_serie = ?";
      private static final String SQL_DELETE1 = "DELETE FROM tbl_devolucion_venta_detalle  WHERE no_serie = ? ";
  public int insert1(Devolucion_Venta insertar)  {
         ResultSet rs = null;
  ...
  public int  update1(Devolucion_Venta insertar)  {
         ResultSet rs = null;
        Connection conn = null;
        PreparedStatement stmt = null;
  ...
  public List<Devolucion_Venta> select1() {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String codigo_factura_encabezado  = rs.getString("codigo_devolucion_encabezado");
  ...
  public   Devolucion_Venta  query1(Devolucion_Venta  venta){
        /**
         *
