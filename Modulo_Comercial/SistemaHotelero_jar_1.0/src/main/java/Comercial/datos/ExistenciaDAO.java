...
public class ExistenciaDAO {
    ...
    private static final String SQL_SELECT = "SELECT Pk_codigo_existencia, Pk_codigo_producto, Pk_codigo_bodega, cantidad_existencia,"
            + "fecha_entrada_existencia, fecha_salida_existencia, estatus_existencia FROM tbl_existencia";

    private static final String SQL_INSERT = "INSERT INTO tbl_existencia (Pk_codigo_existencia, Pk_codigo_producto, Pk_codigo_bodega, cantidad_existencia,"
            + "fecha_entrada_existencia, fecha_salida_existencia, estatus_existencia) VALUES(?,?,?,?,?,?,?,?)";

    private static final String SQL_UPDATE = "UPDATE tbl_existencia SET  Pk_codigo_existencia,"
            + " cantidad_existencia= ?, fecha_entrada_existencia= ?, fecha_salida_existencia=?, estatus_existencia=? WHERE PK_codigo_bodega";

    private static final String SQL_QUERY = "SELECT SELECT Pk_codigo_existencia, Pk_codigo_producto, Pk_codigo_bodega, cantidad_existencia,"
            + "fecha_entrada_existencia, fecha_salida_existencia, estatus_existencia"
            + " FROM tbl_existencia WHERE Pk_codigo_existencia=?";

    private static final String SQL_DELETE = "DELETE FROM tbl_existencia WHERE Pk_codigo_existencia=?";
    ...
    public List<Existencia> select() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                existencia.setPk_codigo_existencia(Pk_codigo_existencia);
    ...
    public int insert(Existencia existencia) {
        ...
        try {
            ...
            stmt.setString(1, existencia.getPk_codigo_existencia());
